...
public class SparkMaxNeoMotor implements Motor {
    ...
    public SparkMaxNeoMotor(Object obj, String propertyName) throws NoSuchFieldException {
        motorSim = new SparkMaxSim(
                Reflections.getPrivateField(obj, propertyName, SparkMax.class),
                DCMotor.getNEO(1));
    }
    ...
    public double simulateFlywheelRPM(double time, double JKgMetersSquared) {
        FlywheelSim sim = new FlywheelSim(
                LinearSystemId.createFlywheelSystem(DCMotor.getNEO(1), JKgMetersSquared, 1), DCMotor.getNEO(1));
